...
This example is best run and developed against the Device Simulator in Xcode.

Huh! I had no idea it's possible to simulate a freeway drive, city-run, bicycle ride, etc., as a Location tool.
    ...
    <script>
      ...
      navigator.geolocation.watchPosition(
        (data) => {
          ...
          // data.coords.heading is the value in degrees relative North
