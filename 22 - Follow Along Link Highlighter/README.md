...
Inspired by a navigational UX experience originally appearing on Stripe.
...
<html lang="en">
  ...
  <body>
    ...
    <script>
      // Grab all links on the page and identify them as triggers
      ...
      function highlightLink() {
        ...
        // Use window scroll values so highlighting bug doesn't appear when scrolling down the page
        const coords = {
      ...
      // Listen for the mouseenter event on each of our links
